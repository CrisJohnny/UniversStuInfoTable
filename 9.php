...
<style>
body{
	SCROLLBAR-FACE-COLOR:rgba(22,22,22,0.5);
	SCROLLBAR-HIGHLIGHT-COLOR:rgba(22,22,22,0.5);
	SCROLLBAR-SHADOW-COLOR:rgba(22,22,22,0.5);
	SCROLLBAR-3DLIGHT-COLOR:rgba(22,22,22,0.5);
	SCROLLBAR-ARROW-COLOR:rgba(22,22,22,0.5);
	SCROLLBAR-TRACK-COLOR:rgba(22,22,22,0.5);
	SCROLLBAR-DARKSHADOW-COLOR:rgba(22,22,22,0.5);
	SCROLLBAR-BASE-COLOR:rgba(22,22,22,0.5);
}
#tx{
	margin-top:10px;
	width:50px;

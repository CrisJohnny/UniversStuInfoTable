...
body{
	animation:50s yd linear alternate infinite;
...
<body>
	...
	<div id="dl">
        ...
        <div style="margin-top:30px;"><hr></div><br><span style=" font-size:30px; color:#fff;">注册</span>
        <div>
        
        	<form action="jiance2.php" method="post">   
            	...
            	<div style=" margin-top:10px;font-size:20px; color:red; width:400px; height:30px;">
